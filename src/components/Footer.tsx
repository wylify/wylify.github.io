...
import { Github, Twitter, Instagram, Linkedin, Mail, ArrowUpRight, AudioWaveform } from "lucide-react";

export default function Footer() {
  return (
    <footer className="bg-obsidian border-t border-white/10 pt-20 pb-10 px-6 md:px-12 relative">
      {/* Bottom Border Integrated - ensures it stays at the top of the footer */}
      <div className="absolute top-0 left-0 right-0 h-[0.5rem] bg-black pointer-events-none" />
      
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          {/* Brand Section */}
          <div className="space-y-6">
            <h2 className="text-3xl font-display tracking-tighter">Fin.</h2>
            <p className="text-sm text-white/40 leading-relaxed max-w-xs">
              You have reached the botom of the site.
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              {["About", "Gallery", "Journal", "Links"].map((label) => (
                <li key={label}>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-4">
              {[
                ...
                { icon: AudioWaveform, label: "Soundcloud" },
